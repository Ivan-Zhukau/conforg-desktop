...
public class ParticipantAdditionalInfo extends BaseEntity {
    ...
    private ParticipantAdditionalInfo(Boolean housing, Boolean meeting,
            UUID address, Boolean culturalProgramm, Boolean eveningMeetingPC,
            Boolean exhibitionPresentationOfReports,
            Boolean tourOfTheCityOfMinsk, Boolean exhibitionStand,
            Boolean programCommitteeMember) {
    ...
    public static class ParticipantAdditionalInfoBuilder {
        ...
        public ParticipantAdditionalInfoBuilder setCulturalProgramm(
                Boolean culturalProgramm) {

            this.culturalProgramm = culturalProgramm;
            return this;
        }

        public ParticipantAdditionalInfoBuilder setEveningMeetingPC(
        ...
        public ParticipantAdditionalInfoBuilder setExhibitionPresentationOfReports(
                Boolean exhibitionPresentationOfReports) {
        ...
        public ParticipantAdditionalInfoBuilder setTourOfTheCityOfMinsk(
                Boolean tourOfTheCityOfMinsk) {

            this.tourOfTheCityOfMinsk = tourOfTheCityOfMinsk;
            return this;
        }

        public ParticipantAdditionalInfoBuilder setExhibitionStand(
        ...
        public ParticipantAdditionalInfoBuilder setProgramCommitteeMember(
                Boolean programCommitteeMember) {
        ...
        public ParticipantAdditionalInfo build() {
            ...
            return new ParticipantAdditionalInfo(housing, meeting, address,
                    culturalProgramm, eveningMeetingPC,
                    exhibitionPresentationOfReports, tourOfTheCityOfMinsk,
