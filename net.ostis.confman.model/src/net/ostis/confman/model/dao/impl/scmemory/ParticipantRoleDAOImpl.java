...
public class ParticipantRoleDAOImpl extends BaseDAOImpl<ParticipantRole>
        implements ParticipantRoleDAO {
    ...
    private enum ScChildRelations implements ScIdentifiable {
        ...
        CULTURAL_PROGRAM(
                "conforg_participant_additional_info_cultural_program*"),
        EVENING_MEETING_PC(
                "conforg_participant_additional_info_evening_meeting_pc*"),
        EXHIBITION_PRESENTATION_OF_REPORTS(
                "conforg_participant_additional_info_exhibition_presentation_of_reports*"),
        TOUR_OF_THE_CITY_OF_MINSK(
                "conforg_participant_additional_info_tour_of_the_city_of_minsk*"),
        EXHIBITION_STAND(
                "conforg_participant_additional_info_exhibition_stand*"),
        PROGRAM_COMMITTEE_MEMBER(
                "conforg_participant_additional_info_program_committee_member*");
    ...
    @Override
    protected void saveFields(ParticipantAdditionalInfo element,
        ...
        ScString culturalProgramContent = ScStrings.wrap(element
                .getCulturalProgramm());
        ...
        ScString eveningMeetingPcContent = ScStrings.wrap(element
                .getEveningMeetingPC());
        ...
        ScString exhibitionPresentationOfReportsContent = ScStrings
                .wrap(element.getExhibitionPresentationOfReports());
        ScAddress exhibitionPresentationOfReportsNode = ScUtils.INSTANCE
                .createNodeWithContent(exhibitionPresentationOfReportsContent);
        ScUtils.INSTANCE.createRelation(parentNode,
                exhibitionPresentationOfReportsNode,
                ScChildRelations.EXHIBITION_PRESENTATION_OF_REPORTS);

        ScString tourOfTheCityOfMinskContent = ScStrings.wrap(element
        ...
        ScString exhibitionStandContent = ScStrings.wrap(element
                .getExhibitionStand());
        ...
        ScString programCommitteeMemberContent = ScStrings.wrap(element
                .getProgramCommitteeMember());
        ScAddress programCommitteeMemberNode = ScUtils.INSTANCE
                .createNodeWithContent(programCommitteeMemberContent);
        ScUtils.INSTANCE.createRelation(parentNode, programCommitteeMemberNode,
                ScChildRelations.PROGRAM_COMMITTEE_MEMBER);

        ScAddress addressAdr = ScUtils.INSTANCE.findElement(element
                .getAddress());
        ScUtils.INSTANCE.createArc(ScElementType.SC_TYPE_ARC_POS, parentNode,
                addressAdr);
    }

    @Override
    protected ParticipantAdditionalInfo readFields(ScAddress addressElement)
            throws DAOException {
        ...
        ScAddress culturalProgramAdr = ScUtils.INSTANCE
                .findUniqueElementByParentAndRelation(addressElement,
                        ScChildRelations.CULTURAL_PROGRAM);
        Boolean culturalProgramContent = ScStrings
                .unwrapToBoolean(ScUtils.INSTANCE
                        .findElementContent(culturalProgramAdr));

        ScAddress eveningMeetingAdr = ScUtils.INSTANCE
                .findUniqueElementByParentAndRelation(addressElement,
                        ScChildRelations.EVENING_MEETING_PC);
        Boolean eveningMeetingContent = ScStrings
                .unwrapToBoolean(ScUtils.INSTANCE
                        .findElementContent(eveningMeetingAdr));

        ScAddress exhibitionPresentationOfReportsAdr = ScUtils.INSTANCE
                .findUniqueElementByParentAndRelation(addressElement,
                        ScChildRelations.EXHIBITION_PRESENTATION_OF_REPORTS);
        Boolean exhibitionPresentationOfReportsContent = ScStrings
                .unwrapToBoolean(ScUtils.INSTANCE
                        .findElementContent(exhibitionPresentationOfReportsAdr));

        ScAddress tourOfTheCityMinskAdr = ScUtils.INSTANCE
                .findUniqueElementByParentAndRelation(addressElement,
                        ScChildRelations.TOUR_OF_THE_CITY_OF_MINSK);
        Boolean tourOfTheCityMinskContent = ScStrings
                .unwrapToBoolean(ScUtils.INSTANCE
                        .findElementContent(tourOfTheCityMinskAdr));
        ...
        ScAddress programCommitteeMemberAdr = ScUtils.INSTANCE
                .findUniqueElementByParentAndRelation(addressElement,
                        ScChildRelations.PROGRAM_COMMITTEE_MEMBER);
        Boolean programCommitteeMemberContent = ScStrings
                .unwrapToBoolean(ScUtils.INSTANCE
                        .findElementContent(programCommitteeMemberAdr));

        // TODO: do something with UUID for Address

        builder.setHousing(housingContent)
                .setMeeting(meetingContent)
                .setCulturalProgramm(culturalProgramContent)
                .setEveningMeetingPC(eveningMeetingContent)
                .setExhibitionPresentationOfReports(
                        exhibitionPresentationOfReportsContent)
                .setTourOfTheCityOfMinsk(tourOfTheCityMinskContent)
                .setExhibitionStand(exhibitionStandContent)
